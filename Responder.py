...
parser.add_option('-s','--status',        action="store_true",  help="Run a Status Webpage  \033[1m\033[31m(Default:False)\033[0m", dest="Status_On_Off", default=False)
...
def main():
	try:
		...
		# Status Loader
		if settings.Config.Status_On_Off:
